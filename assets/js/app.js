    ...
    [2], {
        1: function(e, t, n) {
            ...
            var o = function() {
                ...
                c = function() {
                    for (var e = document.querySelectorAll(".kg-gallery-image img"), t = 0, n = e.length; t < n; t++) {
                ...
                r = function(e) {
                    e(".js-post-content").find("img").each((function() {
                        e(this).closest("figure").hasClass("kg-bookmark-card") || e(this).closest("figure").hasClass("kg-nft-card") || e(this).parent().is("a") || e(this).hasClass("kg-product-card-image") || e(this).hasClass("kg-audio-thumbnail") || e(this).addClass("js-zoomable")
                    }))
                },
                d = function(e, t) {
        ...
        17: function(e, t, n) {
            ...
            a()((function() {
                ...
                var e = a()("body"),
                    ...
                    L = null,
                    D = function() {
                        t.removeClass("submenu-is-active"), r.removeClass("active"), g.removeClass("opened").addClass("closed")
                    },
                    T = function() {
                    ...
                    H = function(e) {
                        Object(h.isMobile)() || (e ? (O.addClass("toggle-overflow"), S.addClass("toggle-overflow")) : (O.removeClass("toggle-overflow"), S.removeClass("toggle-overflow")))
                    };
                (n.on("click", (function() {
                    ...
                    (A = !A) ? (t.addClass("submenu-is-active"), r.addClass("active"), g.removeClass("closed").addClass("opened")) : D()
                })), b.on("click", (function() {
                    w.addClass("opened"), setTimeout((function() {
                        k.trigger("focus")
                    }), 400), T()
                })), j.on("click", (function() {
                    ...
                    if (k.val().length > 0 && x) {
                        var e = x.search(k.val()).filter((function(e) {
                                if (e.score <= .5) return e
                            })),
                            t = "";
                        if (e.length > 0) {
                            for (var n = 0, o = e.length; n < o; n++) t += '\n          <article class="m-result">            <a href="'.concat(e[n].item.url, '" class="m-result__link">              <h3 class="m-result__title">').concat(e[n].item.title, '</h3>              <span class="m-result__date">').concat(Object(h.formatDate)(e[n].item.published_at), "</span>            </a>          </article>");
                            y.hide(), C.html(t), C.show()
                        } else C.html(""), C.hide(), y.show()
                    } else C.html(""), C.hide(), y.hide()
                })), M.on("change", (function() {
                    M.is(":checked") ? (a()("html").attr("data-theme", "dark"), localStorage.setItem("theme", "dark")) : (a()("html").attr("data-theme", "light"), localStorage.setItem("theme", "light"))
                ...
                })), I ? (a()("html").attr("data-theme", I), "dark" === I && M.attr("checked", !0)) : Object(h.isDarkMode)() && M.attr("checked", !0), t.length > 0) && new i.a(t[0], {
                    tolerance: {
                        down: 10,
                        up: 20
                    },
                ...
                if (p.length > 0) new m.d(".js-recent-slider", {
                    modules: [m.b, m.a],
                    freeMode: !0,
                    slidesPerView: "auto",
                    a11y: !0,
                ...
                if ("undefined" != typeof disableFadeAnimation && disableFadeAnimation ? a()("[data-aos]").addClass("no-aos-animation") : d.a.init({
                        once: !0,
                ...
                Object(l.a)(".js-tooltip"), Object(c.a)(".js-article-card-title", 100), Object(c.a)(".js-article-card-title-no-image", 250), "undefined" != typeof disableNewsletter && disableNewsletter && _.remove(), "undefined" != typeof ghostSearchApiKey ? E(ghostHost, ghostSearchApiKey) : (b.css("visibility", "hidden"), j.remove(), w.remove())
            }))
        }
    },
    [
